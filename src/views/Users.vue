<script setup>
  ...
  const dateFormatter = (params) => {
    return params.value ? moment().isSame(params.value, 'day') ? moment(params.value).format('h:mm a') : moment(params.value).format('ddd DD MMM YYYY') : '-';
  }
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-6 space-y-6">
          <FormKit type="form" id="employee" submit-label="Update" @submit="update" :actions="false" #default="{ value }">
