          ...
          <div class="mt-3 md:col-span-2">
              <div class="shadow sm:rounded-md sm:overflow-hidden">
                  <div class="clipboaard-container" v-if="userStore.currentWebsite != 'default'">
                      ...
                      <pre v-highlightjs><code ref="source" class="language-javascript hljs">&lt;script async src='https://www.wibi.co.za/wibi.min.js' data-id='{{ Array.isArray(userStore.currentWebsite) ? userStore.currentWebsite[0] : userStore.currentWebsite }}'> &lt;/script&gt;</code></pre>
                  </div>
