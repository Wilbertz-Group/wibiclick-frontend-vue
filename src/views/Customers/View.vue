...
<template>
	<div class="px-2 py-2 grid md:grid-cols-4 sm:grid-cols-2 gap-3">
						...
						<div class="flex mt-4 space-x-3 md:mt-6">
							...
							<div>
								<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
									...
									viewBox="0,0,256,256"
									class="w-10 h-10 p-1 rounded-full shadow-lg bg-slate-900 hover:bg-slate-700 text-white"
									style="fill:#000000;">
		...
		<div class="col-span-2 md:col-span-2 shadow sm:rounded-md sm:overflow-hidden">
