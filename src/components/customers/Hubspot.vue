...
<template>	
	<div class="flex items-center -space-x-4 hover:space-x-1">
		<a :href="'https://app.hubspot.com/contacts/'+ params.data.portal +'/contact/'+params.value" target="_blank" class="z-20 block p-2.5 bg-rose-100 border-2 border-white rounded-full transition-all active:bg-blue-50 hover:scale-110 focus:outline-none focus:ring">
