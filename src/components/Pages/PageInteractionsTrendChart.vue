<!-- wibiclick-frontend-vue/src/components/Pages/PageInteractionsTrendChart.vue -->
<script setup>
import { ref, computed, watch, onMounted } from 'vue';
import moment from 'moment';

const props = defineProps({
  rawData: { type: Array, required: true }, // Array of page objects with updatedAt
...
const groupedData = computed(() => {
  ...
  const grouped = {};
  props.rawData.forEach(p => {
    // Use updatedAt as the interaction date
    const key = moment(p.updatedAt).format(groupFormat);
