...
<template>
	<div v-for="(invoice) in invoices" :key="invoice.uid" :id="dateTimestamp(invoice.createdAt)" class="shadow rounded-lg sm:overflow-hidden bg-white mb-4">
				...
				<span class="flex items-center">
					<div class="flex items-center -space-x-4 hover:space-x-1" data-v-2fc82866-s="" data-v-2fb1486c-s="">
						<button type="button" class="">
							<svg id="tooltip-invoice-button" data-tooltip-target="tooltip-invoice" class="w-8 h-8 cursor-pointer rounded-full shadow-lg bg-slate-900 hover:bg-slate-700 p-2 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
