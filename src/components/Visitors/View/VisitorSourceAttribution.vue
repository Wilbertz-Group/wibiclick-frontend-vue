      ...
      <div v-else class="px-6 py-8">
        <div class="space-y-4">
          ...
          <div class="flex flex-col gap-1">
            ...
            <div>
              <a v-if="attribution.firstReferrer" :href="attribution.firstReferrer" class="hover:underline text-cyan-300" target="_blank" rel="noopener">
          ...
          <div class="flex flex-col gap-1">
            ...
            <div>
              <a v-if="attribution.lastReferrer" :href="attribution.lastReferrer" class="hover:underline text-cyan-300" target="_blank" rel="noopener">
...
const hasUtm = computed(() =>
  !!(attribution.value &&
    (attribution.value.campaign ||
      attribution.value.medium ||
      attribution.value.term ||
