// wibiclick-frontend-vue/src/components/misc/modalInsuranceAttachment.vue
<script setup>
...
I hope this message finds you well. As per our recent conversation, please find the attached Technician's Damage Assessment Report for your appliance.

This report outlines the extent of the damage, the cause, and the technician's professional opinion on repairability. Kindly review the document and let us know if you have any questions or require further clarification.

We appreciate the opportunity to assist you and look forward to your response.
            ...
            >
              ...
              >
                <div class="">
                  ...
                  <div class="mt-4">
                    <textarea v-model="message" style="height: 300px;" class="w-full p-2 border rounded"></textarea>
                  </div>
