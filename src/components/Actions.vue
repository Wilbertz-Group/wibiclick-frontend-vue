<template>	
	<div class="flex items-center -space-x-4 hover:space-x-1">
		...
		<button
			class="z-30 block p-3 text-red-700 bg-red-100 border-2 border-white rounded-full transition-all hover:scale-110 focus:outline-none focus:ring active:bg-red-50"
			type="button"
		>
			<svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
